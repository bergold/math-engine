(function(window) {
    ...
    _.REGEX_NUMBER     = /(?:\d*\.)?\d+/g;
    _.REGEX_EXP_NUMBER = /(?:\d*\.)?\d+(?:e(?:\+|-)\d+)?/g;
    ...
    _.Mode = (function() {
        ...
        buildMode.getConstantsMap = function() {
            return Object.keys(mathutil.constants);
        };
        buildMode.getFunctionsMap = function() {
            return Object.keys(mathutil.functions);
        };
        buildMode.getOperatorsMap = function() {
            return Object.keys(mathutil.operators);
        };
